...
urlpatterns = [
    ...
    path('telex', weekly_telex, name='telex'),
    ...
    path('ffs-list', fatality_free_shifts, name='ffs-list'),
    path('add-ffs', addFFSData, name='add-ffs'),
    path('update-ffs/<int:pk>', updateffsData, name='update-ffs'),   
