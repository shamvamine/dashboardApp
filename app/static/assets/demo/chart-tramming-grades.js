...
var ctx = document.getElementById("TrammingGradeChart");
    ...
    datasets: [
      {
        ...
        pointHitRadius: 50,
        pointBorderWidth: 2,
        data: chartInfo.western_top_grade,
      },
      {
        label: "Cymric Top",
        lineTension: 0.3,
        ...
        pointHitRadius: 50,
        pointBorderWidth: 2,
        data: chartInfo.cymric_top_grade,
      },
      {
        label: "Cymric Bottom",
        lineTension: 0.3,
        ...
        pointHitRadius: 50,
        pointBorderWidth: 2,
        data: chartInfo.cymric_bottom_grade,
      },
      {
        label: "13 Level",

        borderColor: "rgba(255, 0, 0, 1)",
        data: chartInfo.l_13_grade,
        borderColor: "rgba(255,0,0,1)",
        pointRadius: 5,
